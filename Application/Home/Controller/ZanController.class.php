		...
		if(IS_AJAX){
			if(session('?login')){
				...
				if(count($list)==0){//如果为第一次点赞
					...
					// 1-资讯评论ID、2-资讯评论ID、3-景点ID、4-点赞ID、5-为0、6-城市想去ID、7-城市去过ID、8-景点想去ID、9-景点去过ID、10-点赞ID、11-装备ID、12-游记ID、13-评论ID、14-话题ID、15话题评论ID、16-话题评论ID、17-话题点赞ID、18-话题点赞ID
					//添加动态
